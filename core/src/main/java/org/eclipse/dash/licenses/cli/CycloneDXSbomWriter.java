...
/**
 * Writes an enriched CycloneDX SBOM as JSON or XML (chosen from the output file
 * extension). This is a collector: it takes the already parsed {@link Bom} (from
...
public class CycloneDXSbomWriter implements IResultsCollector {
    ...
    // keyed by IContentId directly — ContentId defines value-based equals()/hashCode()
    ...
    public void close() {
        ...
        // Serialize in the format named by the output extension (JSON or XML).
